...
The Eigen3 package is also required.
...
mkdir build
cd build
cmake -DBUILD_CUDA=ON -DBUILD_PYTHON=ON -DCMAKE_C_FLAGS_RELEASE="-O2 -DNDEBUG"-DCMAKE_CXX_FLAGS_RELEASE="-O2 -DNDEBUG" -DCMAKE_CUDA_FLAGS_RELEASE="-O2 -DNDEBUG" ..
